...
function editor(props) {
  ...
  const [activeDetailIndex, setActiveDetailIndex] = useState(0);  //For Active Chip
...
//This Effect is used for display chips when original information may change then (activeInformation) will update
  useEffect(() => {
...
//When you click particular chips then you will get values in the input field
  useEffect(() => {
    const details = activeInformation?.details;
    if (!details) return;
