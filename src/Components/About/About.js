...
function About() {
  return (
    <div className='mt-4 pt-5'>
      <h1>About us</h1>
      <h5>Resume Builder App have the built in layout that makes resume just writing your Information only and app will make your resume and you can simply download with one click.</h5>
